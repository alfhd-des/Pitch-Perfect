...
class playSoundsVC: UIViewController {
    ...
    // MARK: Actions
    // handle action when playSound button clicked
    ...
    // handle action when stop button clicked
...
// confirm AVAudioPlayerDelegate in extension to keep it clean and readable
